# Instructions for bayesian_fm example #
----------------------------------------
...
./newfm.x -l MeOH_2site_example.dat

3) Compare these results with the files in the "base_output" directory.

4) To generate results after 100 iterations of Bayesian MS-CG, set the
bayesian_mscg_flag to 1 and bayesian_max_iterations to 100. This has been
...
(the *.dat and *.table) files from these two runs.